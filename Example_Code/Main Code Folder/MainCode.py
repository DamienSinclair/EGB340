    ...
    #Returns:
        ...
        #Find which battery is returned by recording surge current
            if ( batOneAlloc and (inaOne.getCurrent_mA() > 5)) :
                ...
                batOneAlloc = 0
                returnNot = 0
                batteryOneCharged = 1   #Testing Purposes
                
            elif ( batTwoAlloc and (inaTwo.getCurrent_mA() > 9999)) :       #Testing purposes
                returnedBattery = 2
                batTwoAlloc = 0
                returnNot = 0
                batteryTwoCharged = 1
            
            elif ( batThreeAlloc and (inaThree.getCurrent_mA() > 9999)) : 
                returnedBattery = 3
                batThreeAlloc = 0
                returnNot = 0
                batteryThreeCharged = 1
        ...
        print "Battery sucessfully returned, thank you - please remove your card"
